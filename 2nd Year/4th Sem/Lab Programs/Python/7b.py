class Employee:
    ...
    def display(self):
        ...
        print("Departnemt : ", self.Department)
...
for x in range(n):
    ...
    dept=input("Enter dept of the employee : ")
    hike=int(input("percentage of hike in salary : "))

for x in range(n):
    if eid == emp[x].Employee_ID and dept == emp[x].Department:
        emp[x].update(hike)

print("Emplyee list with updated salary : ")
for x in range(n):
    emp[x].display()